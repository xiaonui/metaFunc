...
&emsp;&emsp;The `gene profile` should contain at least two columns, the first column is the gene name, and the rest are gene profile. There should be no duplication of genes. `0` will be considered to be absent, and positive numbers mean the gene is present. The structure of the data is shown below:
```{r}
...
Fig 7. Combination block chart (split percentage = 60%)
</center>
</figure>
...
<center>
<figure>
<img src='figure/Fig8-1.png' width='25%'>
<img src='figure/Fig8-2.png' width='65%'>

Fig 8. Combination block chart
</center>
</figure>
...
Fig 10. The detailed information of point
</center>
</figure>
...
<center>
<figure>
<img src='figure/Fig12.png' width='100%'>

Fig 12. A sankey plot
</center>
</figure>
